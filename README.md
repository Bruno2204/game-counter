...
Una aplicación sencilla creada con **React + Vite + Zustand** para llevar el conteo de puntos por rondas entre varios jugadores.
...
```bash
git clone https://github.com/tuusuario/contador-de-puntos.git
